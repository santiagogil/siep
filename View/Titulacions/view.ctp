...
<div id="acordeon_04">
        ...
        <div id="acordeon_05">
            <div class="row"
            >
                  <?php if (!empty($titulacions['Disenocurricular'])):?>
                    <!-- Swiper -->
                    <div class="swiper-container" style="height: 200px;">
                        <div class="swiper-wrapper" >
                          <?php foreach ($titulacions['Disenocurricular'] as $disenocurricular): ?>
                            <div class="swiper-slide">
                                <div class="col-md-6">
                                  <div class="unit">
                                    <?php echo ' <b>Titulación:</b> '.$disenocurricular['titulacion_id']; ?><br/>
                                    <?php echo ' <b>Año:</b> '.$disenocurricular['anio']; ?><br/>
                                    <?php echo ' <b>Resolución N°:</b> '.$this->Html->link($disenocurricular['resolucion_id'], array('controller' => 'resolucions', 'action' => 'view', $disenocurricular['resolucion_id'])); ?></span><br/>
                                    <div class="text-right">
