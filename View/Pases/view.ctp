                ...
                <div class="row perfil">
                    <div class="col-md-4 col-sm-6 col-xs-8">    
                        <b><?php echo __('Ciclo: '); ?></b>
                            <?php echo ($this->Html->link($pase['Pase']['ciclo_id'], array('controller' => 'ciclos', 'action' => 'view', $pase['Pase']['ciclo_id']))); ?></p>
                        <b><?php echo __('Alumno: '); ?></b>
                            <?php echo ($this->Html->link($pase['Pase']['alumno_id'], array('controller' => 'titulacions', 'action' => 'view', $pase['Pase']['alumno_id']))); ?></p>
                        <b><?php echo __('Institución de Destino: '); ?></b>
                            <?php echo ($this->Html->link($pase['Pase']['centro_id_destino'], array('controller' => 'centros', 'action' => 'view', $pase['Pase']['centro_id_destino']))); ?></p>
