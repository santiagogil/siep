<div class="TituloSec"><?php echo __('Agregar Resolución'); ?></div>
    <div id="ContenidoSec">
        <?php echo $this->Form->create('Resolucion', array('novalidate' => true));?>
        <div class="unit">
             <?php echo $this->element('forms/form_resolucion'); ?><p>
        </div>
