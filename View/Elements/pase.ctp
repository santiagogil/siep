<div class="col-md-6">
	<div class="unit">
        ...
        <span class="name"><span class="glyphicon glyphicon-user"></span> <b>Alumno:</b> <?php echo $this->Html->link($personasNombre[$pase['Pase']['alumno_id']], array('controller' => 'alumnos', 'action' => 'view', $pase['Pase']['alumno_id'])); ?></span><br/>
        <hr />
