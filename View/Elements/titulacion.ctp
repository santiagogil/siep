<div class="col-md-6">
	<div class="unit">
         <!--<span class="name"><span class="glyphicon glyphicon-info-sign"></span> <b>Institución:</b> <?php echo $this->Html->link($titulacion['Titulacion']['centro_id'], array('controller' => 'centros', 'action' => 'view', $titulacion['Titulacion']['centro_id'])); ?></span><br/>-->
